...
const IconDatabase = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
    ...
    <path d="M3 4V8C3 9.1 5.2 10 8 10C10.8 10 13 9.1 13 8V4"
      stroke="currentColor" strokeWidth="1.2"/>
    <path d="M3 8V12C3 13.1 5.2 14 8 14C10.8 14 13 13.1 13 12V8"
      stroke="currentColor" strokeWidth="1.2"/>
  </svg>
);
const IconAlert    = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
    <path d="M8 1.5L14.5 13H1.5L8 1.5Z" stroke="currentColor" strokeWidth="1.2"
...
const IconEdit     = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
    ...
    <path d="M10.5 3L13 5.5" stroke="currentColor" strokeWidth="1.2"
      strokeLinecap="round"/>
  </svg>
);
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      'We take your privacy seriously. AfterHours is built with a privacy-first architecture.',
    ],
    bullets: [
  ...
  },
  {
    ...
    body: [
      'When using AfterHours, you agree not to:',
    ],
    bullets: [
      ...
      <div className="tos-scroll">
        ...
        {SECTIONS.map((s) => (
          <section key={s.num} className="tos-section">
            ...
            {/* body paragraphs (before bullets) */}
            {s.body?.map((p, i) => (
        ...
        {/* breathing room above nav if embedded in router */}
